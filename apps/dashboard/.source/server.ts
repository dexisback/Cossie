...
import { default as __fd_glob_3 } from "../content/docs/security/meta.json?collection=docs"
...
export const docs = await create.docs("docs", "content/docs", {"meta.json": __fd_glob_0, "concepts/meta.json": __fd_glob_1, "reference/meta.json": __fd_glob_2, "security/meta.json": __fd_glob_3, }, {"index.md": __fd_glob_4, "concepts/backend-architecture.md": __fd_glob_5, "concepts/policy-engine.md": __fd_glob_6, "concepts/system-design.md": __fd_glob_7, "reference/api.md": __fd_glob_8, "security/security-model.md": __fd_glob_9, });